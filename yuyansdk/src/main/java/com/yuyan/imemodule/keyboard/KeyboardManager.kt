...
class KeyboardManager {
    enum class KeyboardType {
        T9, QWERTY, LX17, QWERTYABC, NUMBER, SYMBOL, SETTINGS, HANDWRITING, CANDIDATES, ClipBoard, TEXTEDIT, AI
    }
    ...
    fun switchKeyboard(keyboardName: KeyboardType) {
        ...
        if (container == null) {
            container = when (keyboardName) {
                ...
                KeyboardType.AI -> AiContainer(Launcher.instance.context, mInputView)
